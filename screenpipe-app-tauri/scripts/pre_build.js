...
const config = {
  ...
  linux: {
    ...
    tesseractUrl:
      "https://github.com/DanielMYT/tesseract-static/releases/download/tesseract-5.5.0/tesseract",
...
async function findWget() {
  ...
  console.error(
    "wget not found. Please install wget and make sure it's in your PATH.",
  );
  process.exit(1);
}
...
if (platform == "macos") {
  ...
  try {
    ...
    console.log(
      ...
      path.join(cwd, "../../screenpipe-vision/src/ui_monitoring_macos.swift"),
    );
